---
name: IP footer — GUIDE-* English
description: Canonical footer block for GUIDE-* operational runbooks in woodfine-fleet-deployment
type: reference
---

<!-- TEMPLATE: footer-guide-en — append verbatim after last content line of any guide-*.md -->
